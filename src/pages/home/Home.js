...
const links = [{ name: "Explore", to: "books" }];
        ...
        <div className="px-6 mx-auto max-w-7xl lg:px-8">
          <div className="max-w-2xl mx-auto lg:mx-0">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-300">
              Uncover a World of Literary Delights: Explore and Shop the Vast
              Library of Our E-Commerce Bookstore
            </p>
          </div>
